"""
Code to handle a SonyAVR receiver.

Taken from Home Assistant:
https://github.com/home-assistant/core/blob/dev/homeassistant/components/songpal/media_player.py
...
class ConnectDenonAVR:
    """Class to async connect to a SonyAVR receiver."""
